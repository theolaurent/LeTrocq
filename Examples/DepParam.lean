...
The prelude dependent pair `Sigma` ships with the library (`Trocq.Std.Sigma`); this file is the worked
...
/- ===================== a family whose domain is NOT the adjacent type argument =====================
   ...
   library's `paramSigmaR` (`Trocq.Std`). -/
